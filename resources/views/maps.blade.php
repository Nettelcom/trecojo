...
@section('header')
    <section class="content-header">
      <h1>
        Mapa<small>Mostrando autos</small>
      </h1>
      <ol class="breadcrumb">
...
@section('content')
        ...
        <div class="col-md-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <div class="box-title">Vista del mapa</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4" id="flow2">
        <button id="getCords" class="btn btn-success" onClick="codeAddress();">Localizar..</button>
    </div>
    </br>
    <!--<div class="page_load">
...
function myMap() {
var mapProp= {
    center:new google.maps.LatLng(-12.0891275,-76.9797458),
    zoom:15,
};
