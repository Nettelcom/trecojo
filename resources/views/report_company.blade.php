...
<table  border="1">
    <tr>
        <td colspan="16" align="center"><strong>TAXI TRECOJO</strong></td>

        {{--<td colspan="12" align="center">LISTADO DE SERVICIOS GENERALES</td>--}}
    </tr>
    <tr>
        <td colspan="16" align="center"><strong>LISTADO DE SERVICIOS GENERALES</strong></td>
    </tr>
    <tr>
        <td colspan="16"></td>
    </tr>
